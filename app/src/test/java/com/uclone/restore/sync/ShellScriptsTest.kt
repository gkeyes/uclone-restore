...
class ShellScriptsTest {
    ...
    fun unlockCloneWithCredential_triesLockSettingsThenUiInputWithRedactedLogs() {
        ...
        assertContains(script, "CURRENT_USER_AFTER_SWITCH=")
        assertContains(script, "BRING_CLONE_HOME_BEGIN")
        assertContains(script, "DIGIT_KEYEVENTS_BEGIN")
        assertContains(script, "KEYCODE_${'$'}DIGIT")
        assertContains(script, "PIN_PAD_TAPS_BEGIN")
        assertContains(script, "PIN_PAD_GRID=${'$'}GRID_NAME")
        assertContains(script, "STATE_AFTER_PIN_PAD_TAPS_UPPER")
        assertContains(script, "STATE_AFTER_PIN_PAD_TAPS_LOWER")
        assertContains(script, "print_ui_summary \"BEFORE_INPUT\"")
        assertContains(script, "AFTER_INPUT_TEXT")
