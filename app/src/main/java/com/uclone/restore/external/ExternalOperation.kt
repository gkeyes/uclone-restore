...
internal fun taskTypeForOperation(operation: String): TaskType = when (operation) {
    ...
    ExternalActionContract.OPERATION_DELETE_CLONE_ROLLBACK -> TaskType.DELETE_CLONE_ROLLBACK
    ...
    ExternalActionContract.OPERATION_SCAN_WORKSPACE_OWNERSHIP -> TaskType.SCAN_WORKSPACE_OWNERSHIP
    ...
    ExternalActionContract.OPERATION_RECOVER_INTERRUPTED_TRANSACTION -> TaskType.RECOVER_INTERRUPTED_TRANSACTION
